...
public class NewsPage extends Matchers {
    ...
    public static void pressSortNews() {
    ...
    public static void pressFilterNews() {
    ...
    public static ViewInteraction newsItemTitle(int position) {
    ...
    public static ViewInteraction newsItemDescription(int position) {
    ...
    public static ViewInteraction newsItemDate(int position) {
        return onView(
